...
Local $app_name = "Janison Quality Assurance Environment"
...
$storage_format = '<a href=\"https://janisoncls.atlassian.net/wiki/download/attachments/494207048/Janison%20Quality%20Assurance%20Environment%20portable.exe\">Click to update page</a><br /><br />'
...
Local $deployment = _OctopusGetLatestTenantIdsDeploymentIdTaskIdCreatedForEnvironment("Environments-27")
...
Local $subscription_arr[4]
$subscription_arr[0] = "LearningDevTest"
$subscription_arr[1] = "ADS Load"
$subscription_arr[2] = "AssessmentDevTest"
$subscription_arr[3] = "SEAB"
...
for $subscription_num = 0 to (UBound($subscription_arr) - 1)
	...
	$ps_script_arr[1] = "Get-AzureRmResource -ResourceType 'Microsoft.Sql/servers' -ResourceGroupName '*-QA*'"
...
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "495845841", "495845860", "Quality Assurance Environment", $storage_format)
